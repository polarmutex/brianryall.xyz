...
<section class="post">
    ...
    <span class="post__date">
        Posted on
        {dayjs(post.creationDate).format('dddd')},
        {dayjs(post.creationDate).format('DD MMMM YYYY')}
    </span>
    <a
        class="post__edit"
        href="https://github.com/polarmutex/brianryall.xyz/blob/master/src/routes/blog/{currentSlug}/index.svx"
        target="_blank"
